...
# bundle and the savings show up in --context-report. Compression is LOCAL and
# deterministic (no API key — `model` only selects the tokenizer); just install it:
